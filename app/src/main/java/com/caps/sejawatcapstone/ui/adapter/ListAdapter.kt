...
class ListAdapter(private val data:MutableList<itemMenu> = mutableListOf(),) : RecyclerView.Adapter<ListAdapter.ListViewHolder>() {
    ...
    class ListViewHolder(verticalView: View) : RecyclerView.ViewHolder(verticalView) {
        var imgPhoto: ImageView = itemView.findViewById(R.id.ImgesView)
        var tvName: TextView = itemView.findViewById(R.id.tv_nnama)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.horizontal_view, parent, false)
